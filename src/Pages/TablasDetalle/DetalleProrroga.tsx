      ...
      <div className="p-6 space-y-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="bg-white border border-gray-200 rounded-lg p-4">
            ...
            <div className="grid gap-2">
              {[{
                ...
                label: "Teléfono", value: prorroga.user?.telefono
              }].map(({ label, value }) => (
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-4">
            ...
            <div className="grid gap-2">
              {[{
                label: "Fecha", value: prorroga.Date ? formatearFecha(prorroga.Date) : "No disponible"
              }, {
                label: "Detalle", value: prorroga.Detalle || "No especificado"
              }].map(({ label, value }) => (
                <div key={label} className="grid grid-cols-[8rem_1fr] items-start gap-2">
                  <span className="text-gray-500">{label}:</span>
