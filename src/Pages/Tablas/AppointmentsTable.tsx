...
//       try {
//         const data = await ApiService.get<Cita[]>(ApiRoutes.citas); // Usa ApiRoutes correctamente
//         setCitas(data);
//       } catch {
...
//     socket.on('nueva-cita', async (nuevaCita: Cita) => {
//       console.log('Nueva cita recibida:', nuevaCita);
    
//       // 🔥 Refrescar toda la lista porque la cita viene incompleta
//       try {
//         const updatedData = await ApiService.get<Cita[]>(ApiRoutes.citas);
//         setCitas(updatedData);
//       } catch (error) {
//         console.error('Error actualizando citas tras nueva cita:', error);
//       }
//     });
